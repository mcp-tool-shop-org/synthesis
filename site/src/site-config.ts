  ...
  sections: [
    {
      ...
      features: [
        ...
        { title: 'Grounded-Uptake Witness', desc: 'The positive companion to empathy-theater. Certifies the observable — that grounded uptake was performed — instead of the undecidable, via five required witnesses (grounded anchor, non-parroting, a support move, template containment, safety compatible). Measures behavior, not sincerity — and claims nothing beyond that. It is not a quality score: the verdict is templatable (measured 73.2%), so it must never be used as a training target or a ranking signal.' },
